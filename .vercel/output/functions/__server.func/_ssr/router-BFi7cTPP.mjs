...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BFi7cTPP.js
var router_BFi7cTPP_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DZLtH03R.css";
var APP_NAME = "Stagehand";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Headless OBS control room. Drive a virtual studio over obs-websocket — scenes, stream, record, and the Docker + Xvfb stack."
			},
			{
				name: "theme-color",
				content: "#090a0c"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					...
					toastOptions: { className: "!bg-surface-2 !text-fg !border-border !font-[family-name:var(--font-sans)]" }
				}),
...
var $$splitComponentImporter = () => import("./routes-VGI9fvil.mjs");
...
//#endregion
export { getRouter, router_BFi7cTPP_exports as t };
